...
path_allvsall_output = ''; % >>> SET directory to save results. 
...
cfg.outputdir = strcat(path_allvsall_output, '/a_left');  % where the output is generated
...
cfg.outputdir = strcat(path_allvsall_output, '/p_left');  % where the output is generated
cfg.crossclass = 'yes';            % time-by-time temporal generalization 
cfg.channels = 'ALL_NOSELECTION';  % for feature selection
...
cfg.outputdir = strcat(path_allvsall_output, '/a_right'); % where the output is generated
cfg.crossclass = 'yes';            % time-by-time temporal generalization
cfg.channels = 'ALL_NOSELECTION';  % for feature selection
...
cfg.outputdir = strcat(path_allvsall_output, '/p_right');  % where the output is generated
cfg.crossclass = 'yes';            % time-by-time temporal generalization 
cfg.channels = 'ALL_NOSELECTION';  % for feature selection
...
func.organize_output(path_allvsall_output)

%% main settings

cfg.startdir = path_allvsall_output;     % 1st lvl results folder
